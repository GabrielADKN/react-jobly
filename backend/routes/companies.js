...
router.patch("/:handle", authenticateJWT, ensureAdmin, async function (req, res, next) {
  try {
...
router.delete("/:handle", authenticateJWT, ensureAdmin, async function (req, res, next) {
  try {
